...
function collectionInit(c) {
    c.langus =      new Array("Български", "Català", "Čeština", "Dansk", "Deutsch", "English", "Ελληνικά", "Eesti", "Español", "Français", "Italiano", "日本語", "한국어", "Latviešu", "Lëtzebuergesch", "Magyar", "Nederlands", "Norsk, Bokmål", "Polski", "Português", "Русский", "Română", "Slovenščina", "Suomi", "Svenska");
    c.langus_code = new Array("bg",        "ca",     "cs",      "da",    "de",      "en",      "el",       "et",    "es",      "fr",       "it",       "ja",     "ko",    "lv",       "lb",             "hu",     "nl",         "nb",            "pl",     "pt",        "ru",      "ro",     "sl",          "fi",    "sv"     );
