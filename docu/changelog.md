...
(The feature is already available for pocket querries, a special nearest list, since version v0.8. At this point, not all of the nearest lists were tested enough, so we are now delivering the rest.)<br>
