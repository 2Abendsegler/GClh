...
<ul>
<li>
New: [Issue <a href="https://github.com/2Abendsegler/GClh/issues/339">#339</a>] Change link "Lists" on "my" pages from new page <code>.../account/lists</code> to old-fashioned page ```.../my/lists.aspx```. <b>The parameter has to be activated in Config after installation</b>:<br>
