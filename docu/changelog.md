...
<ul>
	...
	<li>
		...
		If you want to get all the links to Google Maps back, then the add-on "Google Search Maps Button" might interest you. You should only use one of the two, the add-on or our new feature. In any case, we were inspired by the add-on to make our adjustments. Thanks to the developer.<br><br>
