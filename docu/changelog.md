...
## v0.3:
<ul>
<li>New: [Issue #35] Hide archived caches in owned cache list.<br>
Vielen Dank an <a href="https://github.com/haarspalter">haarspalter</a> für die Entwicklung.<br></li>
<li>New: [Issue #92] Added date format dd.MM.yyyy<br>
