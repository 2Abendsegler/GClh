...
<ul>
	...
	<li>
		Or you can select the link to the configurator in the menu of your script manager (Tampermonkey) in your browser.<br>
...
<ul>
	...
	<li>
		Oder du kannst in deinem Browser im Menü deines Scriptmanagers (Tampermonkey) den Link zum Konfigurator auswählen.<br>
