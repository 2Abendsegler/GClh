...
* We do not support Android devices at the moment. Nevertheless, the script is functional on Android with only a few restrictions. Here is described one of the ways to install the srcipt on Android devices. In the [FAQs](https://github.com/2Abendsegler/GClh/blob/master/docu/faq.md#3-en) there are some hints for using on Android devices.<br>
