...
//<-- $$006
            ...
            html += " <input class='gclh_form' type='text' size='12' id='settings_show_copydata_own_stuff_name' value='" + settings_show_copydata_own_stuff_name + "'>";
            ...
            html += " <input class='gclh_form' type='text' size='34' id='settings_show_copydata_own_stuff_value' value='" + settings_show_copydata_own_stuff_value + "'>";
