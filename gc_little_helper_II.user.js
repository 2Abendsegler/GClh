...
var variablesInit = function (c) {
    ...
    externalBookmark("Changelog", "https://github.com/2Abendsegler/GClh/blob/master/docu/changelog.md", c.bookmarks);
...
//   Message Center gearbeitet. Versucht man es fünf Minuten später nochmal identisch, dann funktioniert es.
    if ( settings_show_message && is_page("messagecenter") && document.location.href.match(/&text=(.*)/) ) {
        try {
            ...
            upd();
        } catch (e) { gclh_error("Improve Message Site:", e); }
    }
...
// Aufbau Links zum Aufruf von Config, Sync und Find Player. Und Changelog im Profile.
    try {
        ...
        if ( is_page("profile") && document.getElementById('ctl00_ContentBody_WidgetMiniProfile1_memberProfileLink') ) {
            ...
            var lnk_changelog = " | <a href='https://github.com/2Abendsegler/GClh/blob/master/docu/changelog.md' style='font-size: 0.9em;' title='Documentation of changes and new features in GClh II on GitHub'>Changelog</a>";
...
//<-- $$000 End of change
        ...
        setTimeout(function() {
            var url = "https://github.com/2Abendsegler/GClh/blob/master/docu/changelog.md";
...
// Configuration Menu.
    function gclh_showConfig() {
        ...
        if (document.getElementById('settings_overlay') && document.getElementById('settings_overlay').style.display == "none") {
            ...
            html += "<a href='https://github.com/2Abendsegler/GClh/blob/master/docu/changelog.md' title='Documentation of changes and new features in GClh II on GitHub' target='_blank'>Changelog</a> | ";
